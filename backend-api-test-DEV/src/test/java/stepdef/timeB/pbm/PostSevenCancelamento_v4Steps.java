...
public class PostSevenCancelamento_v4Steps {
    private static String ROTA = Pbmv4.POST_SEVEN_CANCELAMENTO;

    @Dado("possuo dados para PbmService - v4 - PostSevenCancelamento:")
    public void possuo_dados_para_pbm_service_v4_post_seven_cancelamento(DataTable dataTable) throws JsonProcessingException {
    ...
    public void executo_pbm_service_v4_post_seven_cancelamento() {
        Pbmv4.postSevenCancelamento.run();
    }

    @Entao("sistema processa PbmService - v4 - PostSevenCancelamento:")
    public void sistema_processa_pbm_service_v4_post_seven_cancelamento(DataTable dataTable) throws Exception {
    ...
    public void executeCancelamentoFromPbm(PostCancelamentoRequest_v4 input) {
        ...
        executo_pbm_service_v4_post_seven_cancelamento();
    }
}
