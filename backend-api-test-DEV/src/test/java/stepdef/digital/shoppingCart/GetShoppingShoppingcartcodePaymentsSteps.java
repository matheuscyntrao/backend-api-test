...
public class GetShoppingShoppingcartcodePaymentsSteps {
    @Dado("possuo dados para ShoppingCart - Payment - GetShoppingcartcodePayments_v1 path:")
    public void possuo_dados_para_shopping_cart_payment_get_shoppingcartcode_payments_v1_path(Map<String, String> dataTable) {
    ...
    public void executo_shopping_cart_payment_get_shoppingcartcode_payments_v1() {
    ...
    public void sistema_processa_shopping_cart_payment_get_shoppingcartcode_payments_v1(DataTable dataTable) throws Exception {
